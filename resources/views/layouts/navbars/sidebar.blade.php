<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('r.catalogo') }}">
                        <i class="ni ni-shop text-primary"></i> {{ __('La Livre') }}
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                        <a class="nav-link" href="{{ route('r.autor') }}">
                ...
                @can('es_admin', Auth()->user())    
                <li class="nav-item">
                        <a class="nav-link" href="{{ route('r.categoria') }}">
                ...
                @can('es_admin', Auth()->user())    
                <li class="nav-item">
                        <a class="nav-link" href="{{ route('r.venta') }}">
                ...
                @endcan
                <li class="nav-item">
                        <a class="nav-link" href="{{ route('r.dtventa') }}">
                        <i class="ni ni-sound-wave text-default"></i>
                        <span class="nav-link-text">Detalles de Venta</span>
                        </a>
                    </li>
